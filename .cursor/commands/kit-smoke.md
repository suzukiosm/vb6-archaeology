...
- config-check / extract / inventory / verify（End 数・名前集合）/ deep-read / deep-read-all / layout / comprehend（skeleton · tick · --unticked · --suggest）/ excerpt / io-catalog / status / serve --check · --live-get / scan-chars が例外なく終了
